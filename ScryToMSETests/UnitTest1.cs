...
namespace ScryToMSETests
{
    ...
    public class Class7_RuleText
    {
        ...
        [TestMethod]
        public void TestGetRuleTextTwoStringTwoCost()
        {
        ...
        [TestMethod]
        public void TestGetRuleTextOneStringTwoCost()
        {
            var res = "\tspecial_text:\u000A" +
                "\t\tЗемлепад — Каждый раз, когда земля выходит на поле битвы под вашим контролем, положите один жетон верности на Ниссу Тенистых Ветвей.\u000A" +
                "\t\t+1: разверните целевую землю под вашим контролем. Вы можете заставить ее стать существом 3/3 Элементаль с " +
                "Ускорением и Угрозой до конца хода. При этом она остается землей.\u000A" +
                "\t\t−5: вы можете положить из вашей руки или из вашего кладбища карту существа с конвертированной мана-стоимостью, не превышающей число земель " +
                "под вашим контролем, на поле битвы с двумя дополнительными жетонами +1/+1 на ней.\u000A" +
                "\tlevel_1_text: \u000A" +
                "\t\tЗемлепад — Каждый раз, когда земля выходит на поле битвы под вашим контролем, положите один жетон верности на Ниссу Тенистых Ветвей.\u000A" +
                "\tloyalty_cost_2: +1\u000A" +
                "\tlevel_2_text: \u000A" +
                "\t\tразверните целевую землю под вашим контролем. Вы можете заставить ее стать существом 3/3 Элементаль с " +
                "Ускорением и Угрозой до конца хода. При этом она остается землей.\u000A" +
                "\tloyalty_cost_3: -5\u000A" +
                "\tlevel_3_text: \u000A" +
                "\t\tвы можете положить из вашей руки или из вашего кладбища карту существа с конвертированной мана-стоимостью, не превышающей число земель " +
                "под вашим контролем, на поле битвы с двумя дополнительными жетонами +1/+1 на ней.\u000A";
            Assert.AreEqual(GetRuleTextString(GetCard("ZNR", 231, "ru")), res);
        }

        [TestMethod]
        public void TestGetRuleTextThreeCost()
        {
            var res = "\tspecial_text:\u000A" +
                "\t\t+1: создайте одну фишку существа 1/1 белый Кор Воин. Вы можете прикрепить к нему Снаряжение под вашим контролем.\u000A" +
                "\t\t−2: посмотрите шесть верхних карт вашей библиотеки. Вы можете показать находящуюся среди них карту Воина или Снаряжения и положить ее в вашу руку. " +
                "Положите остальные карты в низ вашей библиотеки в случайном порядке.\u000A" +
                "\t\t−3: Нахири, Наследница Древних наносит целевому существу или planeswalker'у повреждения, равные удвоенному количеству Снаряжения под вашим контролем.\u000A" +
                "\tloyalty_cost_1: +1\u000A" +
                "\tlevel_1_text: \u000A" +
                "\t\tсоздайте одну фишку существа 1/1 белый Кор Воин. Вы можете прикрепить к нему Снаряжение под вашим контролем.\u000A" +
                "\tloyalty_cost_2: -2\u000A" +
                "\tlevel_2_text: \u000A" +
                "\t\tпосмотрите шесть верхних карт вашей библиотеки. Вы можете показать находящуюся среди них карту Воина или Снаряжения и положить ее в вашу руку. " +
                "Положите остальные карты в низ вашей библиотеки в случайном порядке.\u000A" +
                "\tloyalty_cost_3: -3\u000A" +
                "\tlevel_3_text: \u000A" +
                "\t\tНахири, Наследница Древних наносит целевому существу или planeswalker'у повреждения, равные удвоенному количеству Снаряжения под вашим контролем.\u000A";
            Assert.AreEqual(GetRuleTextString(GetCard("ZNR", 230, "ru")), res);
        }
    }
